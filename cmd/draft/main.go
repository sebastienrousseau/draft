...
ENGINE
  ...
  claude, copilot, and codex are verified end to end and used by auto mode; the
  rest are experimental (invocation correct, output unverified) and are used by
  auto only with --experimental. Any provider can still be forced by name.
